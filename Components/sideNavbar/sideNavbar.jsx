...
const SideNavbar = ({ sideNavbar, setSideNavbarFunc }) => {
  const navigate = useNavigate();

  return (
    <div className={sideNavbar ? 'home-sideNavbar show' : 'home-sideNavbar hide'}>
      
      {/* Hamburger Toggle */}
      <div className="home_sideNavbarHeader">
        <div className="navbarhamburger" onClick={() => setSideNavbarFunc(false)}>
          <MenuIcon sx={{ color: 'white' }} />
        </div>
        <h3 className="home_sideNavbarTitle">Menu</h3>
      </div>
      ...
      <div className="home_sideNavbarMiddle">
        ...
        <div className="home_sideNavbarTopOption">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8t7oy87rkFf7MqMkYim4St0aaK1XDIO0DLQ&s"
            alt=""
            className="home_sideNavbar_ImgLogo"
          />
        ...
        <div className="home_sideNavbarTopOption">
          <img
            src="https://yt3.googleusercontent.com/ytc/AIdro_kr4Xv6GpEaeOVO9n6gQ29NDGs4YuW2HJkGOSqaZ1IAoA=s900-c-k-c0x00ffffff-no-rj"
            alt=""
            className="home_sideNavbar_ImgLogo"
          />
